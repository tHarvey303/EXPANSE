...
fit_instructions_delayed = {"t_bc":0.01,
                sfh_type:sfh,
                "nebular":nebular,
                "dust":dust}

meta_delayed = {'run_name':'photoz_delayed', 'redshift':'self', 'redshift_sigma':'min',
...
fit_instructions_continuity = {"t_bc":0.01,
                'continuity':continuity,
                "nebular":nebular,
                "dust":dust}

meta_continuity = {'run_name':'photoz_continuity', 'redshift':'self', 'redshift_sigma':'min',
        'min_redshift_sigma':0.5, 'fit_photometry':'TOTAL_BIN',
        'sampler':'multinest'}

overall_dict = {'meta': meta_continuity, 'fit_instructions': fit_instructions_continuity}
...
sfh["tau"] = (0.001, 3.)                # Vary the time of peak star-formation between
...
sfh["alpha"] = (0, 10.)          # Vary the falling power law slope from 0.01 to 1000.
sfh["beta"] = (0, 10.)           # Vary the rising power law slope from 0.01 to 1000.
...
fit_instructions_dpl = {"t_bc":0.01,
                sfh_type:sfh,
                "nebular":nebular,
                "dust":dust}

meta_dpl = {'run_name':'photoz_dpl', 'redshift':'self', 'redshift_sigma':'min',
        'min_redshift_sigma':0.5, 'fit_photometry':'TOTAL_BIN',
        'sampler':'multinest'}
...
fit_instructions_lognorm = {"t_bc":0.01,
                sfh_type:sfh,   
                "nebular":nebular,  
                "dust":dust}

meta_lognorm = {'run_name':'photoz_lognorm', 'redshift':'self', 'redshift_sigma':'min',
        'min_redshift_sigma':0.5, 'fit_photometry':'TOTAL_BIN',
        'sampler':'multinest'}
...
fit_instructions_resolved = {"t_bc":0.01,
...
meta_resolved = {'run_name':'CNST_SFH_RESOLVED', 'redshift':'photoz_delayed', 'redshift_id':'TOTAL_BIN',
        'fit_photometry':'bin'}
